...
function decode_paging_nav() {
        ...
        <nav class="navigation paging-navigation" role="navigation">
                ...
                <div class="nav-links">
                        ...
                        <div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span>&nbsp;مطالب قدیمی‌تر', 'decode' ) ); ?></div>
                        <?php endif; ?>

                        <?php if ( get_previous_posts_link() ) : ?>
                        <div class="nav-next"><?php previous_posts_link( __( 'مطالب جدیدترs&nbsp;<span class="meta-nav">&rarr;</span>', 'decode' ) ); ?></div>
                        <?php endif; ?>
